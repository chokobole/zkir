...
#ifndef ZKIR_DIALECT_ELLIPTICCURVE_CONVERSIONS_ELLIPTICCURVETOFIELD_POINTOPERATIONS_POINTCODEGEN_H_
#define ZKIR_DIALECT_ELLIPTICCURVE_CONVERSIONS_ELLIPTICCURVETOFIELD_POINTOPERATIONS_POINTCODEGEN_H_
...
#include "zkir/Dialect/EllipticCurve/IR/PointOperationSelector.h"
...
template <mlir::zkir::elliptic_curve::PointKind Kind>
class PointTraits<mlir::zkir::elliptic_curve::PointCodeGenBase<Kind>> {
public:
  constexpr static CurveType kType = CurveType::kShortWeierstrass;

  using AffinePoint = mlir::zkir::elliptic_curve::PointCodeGenBase<
      mlir::zkir::elliptic_curve::PointKind::kAffine>;
  using JacobianPoint = mlir::zkir::elliptic_curve::PointCodeGenBase<
      mlir::zkir::elliptic_curve::PointKind::kJacobian>;
  using PointXyzz = mlir::zkir::elliptic_curve::PointCodeGenBase<
      mlir::zkir::elliptic_curve::PointKind::kXYZZ>;
  using BaseField = mlir::zkir::elliptic_curve::FieldCodeGen;
};
...
#endif // ZKIR_DIALECT_ELLIPTICCURVE_CONVERSIONS_ELLIPTICCURVETOFIELD_POINTOPERATIONS_POINTCODEGEN_H_
